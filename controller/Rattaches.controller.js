sap.ui.define([
	...
	return BaseController.extend("com.eramet.depanneur.HATDepanneurApp.controller.Rattaches", {
		...
		_onRouteMatched: function (oEvent) {
			if (oEvent.getParameter("name") === "Rattaches") {
				if(util.sRattachesButtonText.split("--")[1] === "avisRattache") {
					...
					this.getView().byId("rattaches").setTitle(sTitle + " " + util.aEquipment.equipement);
					this.getView().byId("actualPosition").setText(sTitle);
					this.getView().byId("actualPosition").setTooltip(sTitle);
		...
		_openDateDialog: function () {
			var dateDialog = sap.ui.xmlfragment("com.eramet.depanneur.HATDepanneurApp.view.fragment.dateDialog", this);
		...
		_resetModel: function () {
			var aElements = [
				...
				{
					"title": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "N° avis 0002" : "N° OT 0000002",
					"text": "Description 2",
					"date": "18/10/2019",
					...
					"status": "En cours",
					"icon": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "" : "sap-icon://flag",
					"type": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "" : "Type d'activité 2"
				},
				{
					"title": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "N° avis 0003" : "N° OT 0000003",
					"text": "Description 3",
			    	"date": "17/10/2019",
		    		...
		    		"status": "Clôturé",
		    		"icon": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "" : "sap-icon://flag",
		    		"type": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "" : "Type d'activité 3"
				},
				{
					"title": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "N° avis 0004" : "N° OT 0000004",
					"text": "Description 4",
			    	"date": "21/10/2019",
			    	"convertedDate": "1571608800000",
			    	...
			    	"status": "Repoussé",
			    	"icon": "",
			    	"type": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "" : "Type d'activité 4"
				},
				{
					"title": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "N° avis 0005" : "N° OT 0000005",
			    	"text": "Description 5",
			    	"date": "15/10/2019",
		    		...
		    		"status": "Clôturé",
		    		"icon": "",
		    		"type": util.sRattachesButtonText.split("--")[1] === "avisRattache" ? "" : "Type d'activité 5"
				}
			];
